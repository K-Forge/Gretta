...
-- ====================
INSERT INTO Usuarios (nombre, apellido, correo, telefono, contrasena, rol, canalPreferido, fechaRegistro) VALUES
('Juan', 'Pérez', 'juanp@example.com', 3001111111, 'clave1', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('María', 'López', 'marial@example.com', 3001111112, 'clave2', 'C', 'Email', CURRENT_TIMESTAMP),
('Pedro', 'Gómez', 'pedrog@example.com', 3001111113, 'clave3', 'E', 'SMS', CURRENT_TIMESTAMP),
('Laura', 'Martínez', 'lauram@example.com', 3001111114, 'clave4', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Ana', 'Torres', 'anat@example.com', 3001111115, 'clave5', 'E', 'Email', CURRENT_TIMESTAMP),
('Carlos', 'Ruiz', 'carlosr@example.com', 3001111116, 'clave6', 'C', 'SMS', CURRENT_TIMESTAMP),
('Lucía', 'Hernández', 'luciah@example.com', 3001111117, 'clave7', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Andrés', 'Morales', 'andresm@example.com', 3001111118, 'clave8', 'E', 'Email', CURRENT_TIMESTAMP),
('Paula', 'Castro', 'paulac@example.com', 3001111119, 'clave9', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Mateo', 'Ramírez', 'mateor@example.com', 3001111120, 'clave10', 'E', 'SMS', CURRENT_TIMESTAMP),
('Sofía', 'Vargas', 'sofiav@example.com', 3001111121, 'clave11', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Julián', 'Mendoza', 'julianm@example.com', 3001111122, 'clave12', 'E', 'Email', CURRENT_TIMESTAMP),
('Camila', 'Ortega', 'camilao@example.com', 3001111123, 'clave13', 'C', 'SMS', CURRENT_TIMESTAMP),
('Diego', 'García', 'diegog@example.com', 3001111124, 'clave14', 'E', 'WhatsApp', CURRENT_TIMESTAMP),
('Valentina', 'Suárez', 'valen@example.com', 3001111125, 'clave15', 'C', 'Email', CURRENT_TIMESTAMP),
('Daniel', 'Mejía', 'danielm@example.com', 3001111126, 'clave16', 'C', 'SMS', CURRENT_TIMESTAMP),
('Isabella', 'Cortés', 'isabel@example.com', 3001111127, 'clave17', 'E', 'WhatsApp', CURRENT_TIMESTAMP),
('Tomás', 'Reyes', 'tomasr@example.com', 3001111128, 'clave18', 'C', 'Email', CURRENT_TIMESTAMP),
('Gabriela', 'Jiménez', 'gabrie@example.com', 3001111129, 'clave19', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Santiago', 'Luna', 'santi@example.com', 3001111130, 'clave20', 'E', 'SMS', CURRENT_TIMESTAMP),
('Mariana', 'Rojas', 'marianar@example.com', 3001111131, 'clave21', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Felipe', 'Díaz', 'feliped@example.com', 3001111132, 'clave22', 'E', 'Email', CURRENT_TIMESTAMP),
('Natalia', 'Gil', 'nataliag@example.com', 3001111133, 'clave23', 'C', 'SMS', CURRENT_TIMESTAMP),
('Emilio', 'Paredes', 'emiliop@example.com', 3001111134, 'clave24', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Martina', 'Cano', 'martinac@example.com', 3001111135, 'clave25', 'E', 'Email', CURRENT_TIMESTAMP),
('Sebastián', 'Molina', 'sebasm@example.com', 3001111136, 'clave26', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Luciana', 'Guzmán', 'lucianag@example.com', 3001111137, 'clave27', 'E', 'SMS', CURRENT_TIMESTAMP),
('Samuel', 'Navarro', 'samueln@example.com', 3001111138, 'clave28', 'C', 'Email', CURRENT_TIMESTAMP),
('Laura', 'Pérez', 'laurap2@example.com', 3001111139, 'clave29', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Nicolás', 'Herrera', 'nicolash@example.com', 3001111140, 'clave30', 'E', 'Email', CURRENT_TIMESTAMP),
('Alejandra', 'Vega', 'aleja@example.com', 3001111141, 'clave31', 'C', 'SMS', CURRENT_TIMESTAMP),
('Cristian', 'Moreno', 'cristim@example.com', 3001111142, 'clave32', 'E', 'WhatsApp', CURRENT_TIMESTAMP),
('Julieta', 'Campos', 'julietac@example.com', 3001111143, 'clave33', 'C', 'Email', CURRENT_TIMESTAMP),
('David', 'Núñez', 'davidn@example.com', 3001111144, 'clave34', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Sara', 'Figueroa', 'saraf@example.com', 3001111145, 'clave35', 'E', 'SMS', CURRENT_TIMESTAMP),
('Manuel', 'Santos', 'manuels@example.com', 3001111146, 'clave36', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Victoria', 'León', 'victo@example.com', 3001111147, 'clave37', 'E', 'Email', CURRENT_TIMESTAMP),
('Esteban', 'Prieto', 'estebanp@example.com', 3001111148, 'clave38', 'C', 'SMS', CURRENT_TIMESTAMP),
('Renata', 'Quintero', 'renataq@example.com', 3001111149, 'clave39', 'E', 'WhatsApp', CURRENT_TIMESTAMP),
('Adrián', 'Serrano', 'adrians@example.com', 3001111150, 'clave40', 'C', 'Email', CURRENT_TIMESTAMP),
('Elena', 'Salazar', 'elenas@example.com', 3001111151, 'clave41', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Andrés', 'Rincón', 'andresr@example.com', 3001111152, 'clave42', 'E', 'SMS', CURRENT_TIMESTAMP),
('Carolina', 'Peña', 'carop@example.com', 3001111153, 'clave43', 'C', 'Email', CURRENT_TIMESTAMP),
('Jorge', 'Bermúdez', 'jorgeb@example.com', 3001111154, 'clave44', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Lina', 'Osorio', 'linao@example.com', 3001111155, 'clave45', 'E', 'Email', CURRENT_TIMESTAMP),
('Andrés', 'Valdés', 'andresv@example.com', 3001111156, 'clave46', 'C', 'SMS', CURRENT_TIMESTAMP),
('Daniela', 'Pardo', 'danielap@example.com', 3001111157, 'clave47', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Felipe', 'Zapata', 'felipez@example.com', 3001111158, 'clave48', 'E', 'Email', CURRENT_TIMESTAMP),
('Laura', 'Ceballos', 'laurace@example.com', 3001111159, 'clave49', 'C', 'SMS', CURRENT_TIMESTAMP),
('Simón', 'Orozco', 'simono@example.com', 3001111160, 'clave50', 'E', 'WhatsApp', CURRENT_TIMESTAMP),
('Catalina', 'Rosales', 'catar@example.com', 3001111161, 'clave51', 'C', 'Email', CURRENT_TIMESTAMP),
('Pablo', 'Silva', 'pablos@example.com', 3001111162, 'clave52', 'E', 'SMS', CURRENT_TIMESTAMP),
('Gabriela', 'Patiño', 'gabrip@example.com', 3001111163, 'clave53', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Cristina', 'Ospina', 'crisao@example.com', 3001111164, 'clave54', 'C', 'Email', CURRENT_TIMESTAMP),
('Rafael', 'Mejía', 'rafaelm@example.com', 3001111165, 'clave55', 'E', 'WhatsApp', CURRENT_TIMESTAMP),
('María', 'Vallejo', 'mariav@example.com', 3001111166, 'clave56', 'C', 'SMS', CURRENT_TIMESTAMP),
('Héctor', 'Pérez', 'hectorp@example.com', 3001111167, 'clave57', 'C', 'WhatsApp', CURRENT_TIMESTAMP),
('Camila', 'Arango', 'camilaa@example.com', 3001111168, 'clave58', 'E', 'Email', CURRENT_TIMESTAMP),
('Nicolás', 'Montoya', 'nico2@example.com', 3001111169, 'clave59', 'C', 'SMS', CURRENT_TIMESTAMP),
('Lucía', 'Sierra', 'lucias@example.com', 3001111170, 'clave60', 'E', 'WhatsApp', CURRENT_TIMESTAMP);
...
(1, 1, 1, 1, '2025-02-10', '10:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Cliente puntual'),
(2, 2, 2, 2, '2025-02-12', '11:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Primera cita'),
(3, 3, 3, 3, '2025-02-14', '14:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Solicita tinte'),
(4, 4, 4, 4, '2025-02-15', '15:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Peinado boda'),
(5, 5, 5, 5, '2025-02-16', '09:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Manicure urgente'),
(6, 6, 6, 6, '2025-10-27', '13:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Pedicure'),
(7, 7, 7, 7, '2025-02-18', '12:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Alisado'),
(8, 8, 8, 8, '2025-10-27', '16:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Maquillaje noche'),
(9, 9, 9, 9, '2025-02-20', '17:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Depilación'),
(10, 10, 10, 10, '2025-02-21', '18:00:00', 1, CURRENT_TIMESTAMP, 'Confirmada', 'Tratamiento capilar');
...
-- ====================
-- 10. HISTORIAL CLIENTE (20 registros)
-- ====================
...
-- ====================
-- 14. TipoNotificacion (3 registros)
-- ====================
...
-- ====================
-- 16. ChatConversacion y ChatMensaje
-- ====================
...
SELECT 
    ...
    'Chatbot',
    cb.respuestaChatbot,
    cb.fechaMensaje + INTERVAL '1 minute'
FROM ChatbotWhatsApp cb
JOIN Citas ci ON cb.idCita = ci.idCita
JOIN Cliente cl ON ci.idCliente = cl.idCliente
JOIN ChatConversacion cc ON cc.idCliente = cl.idCliente;
